...
static const char *supported_languages[N_SUPPORTED_LANGUAGES] = {
  "af", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "eo", "fi",
  "fr", "grc", "hi", "hr", "hu", "hy", "id", "is", "it", "ku", "la",
  "lv", "mk", "nl", "no", "pl", "pt", "pt-pt", "ro", "ru", "sk", "sq",
  "sr", "sv", "sw", "ta", "tr", "zh"
};
...
void Speaker::playSound(Speaker *left, Speaker *right, const std::string &sound, double volume, double pitch, double balance, bool loop) {
