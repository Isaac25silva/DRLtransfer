...
testlib = ctypes.CDLL('/home/fei/goalkeeperDRL/examples/blackboard/blackboard.so') #chama a lybrary que contem as funções em c++
...
dqn = DQNAgent(model=model, nb_actions=nb_actions, policy=policy, memory=memory, enable_double_dqn=False,
